      ...
      <NavbarContainer>
        ...
        </ButtonContainer>
        {
          ...
          <MobileMenu isOpen={isOpen}>
            ...
            <LinkedInButton style={{padding: '10px 16px',background: `${theme.primary}`, color: 'white',width: 'max-content'}} href={Bio.github} target="_blank">LinkedIn Profile</LinkedInButton>
          </MobileMenu>
        }
      </NavbarContainer>
    </Nav>
